...
public class AppConstant {
    ...
    public static final String NEED_SUPPORT_COMPANION = "10";
    public static final String NEED_SUPPORT_COMPANION_GUIDE = "11";
    public static final String NEED_SUPPORT_COMPANION_WELL = "12";
